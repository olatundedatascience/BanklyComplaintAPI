namespace ComplaintAPI.ApiRouteSettings
{
    public class ApiRoutes
    {
        ...
        {
            public const string registerClient = url_format + "/registerComplaint";
        }

        public const string registerComplaint = ClientRegistration.registerClient;
    }
